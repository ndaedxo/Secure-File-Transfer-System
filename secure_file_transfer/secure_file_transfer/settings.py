# secure_file_transfer\secure_file_transfer\settings.py
...
SECRET_KEY = 'django-insecure-_!^do(203@2mhe*2obqez1%t-6w4#4fi0zj$$q=bnh+kvlw-a9'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'SecureTransfare_db',
        'USER': 'thriftstore_user',
        'PASSWORD': 'Douvretenser30',
        'HOST': 'localhost',
        'PORT':'5432',
    }
}
